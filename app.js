...
const DEFAULT_TASKS = {
  1: [ // 周一
    ...
    { id:'t1_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t1_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t1_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t1_5', name:'管乐队训练', type:'other', category:'activity', cultivation:0, required:false, marker:true }
  ],
  2: [ // 周二
    { id:'t2_1', name:'语文作业', type:'chinese', category:'study', cultivation:10, required:true },
    { id:'t2_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t2_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t2_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t2_5', name:'学而思数学作业', type:'math', category:'keyStudy', cultivation:15, required:true },
    { id:'t2_6', name:'跳绳3组×1分钟', type:'sport', category:'sport', cultivation:8, required:true, isJumpRope:true }
  ],
  3: [ // 周三（无作业日，无校内作业，仅校外培训）
    { id:'t3_1', name:'美博英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t3_2', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t3_3', name:'学而思数学作业', type:'math', category:'keyStudy', cultivation:15, required:true }
  ],
  4: [ // 周四
    { id:'t4_1', name:'语文作业', type:'chinese', category:'study', cultivation:10, required:true },
    { id:'t4_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t4_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t4_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t4_5', name:'跳绳3组×1分钟', type:'sport', category:'sport', cultivation:8, required:true, isJumpRope:true }
  ],
  5: [ // 周五
    { id:'t5_1', name:'语文作业', type:'chinese', category:'study', cultivation:10, required:true },
    { id:'t5_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t5_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t5_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t5_5', name:'足球队训练', type:'sport', category:'activity', cultivation:0, required:false, marker:true }
  ],
  6: [ // 周六
    { id:'t6_1', name:'语文作业', type:'chinese', category:'study', cultivation:10, required:true },
    { id:'t6_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t6_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t6_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t6_5', name:'跳绳3组×1分钟', type:'sport', category:'sport', cultivation:8, required:false, isJumpRope:true }
  ],
  0: [ // 周日
    { id:'t0_1', name:'语文作业', type:'chinese', category:'study', cultivation:10, required:true },
    { id:'t0_2', name:'Ryan老师的作业', type:'english', category:'study', cultivation:10, required:true },
    { id:'t0_3', name:'新东方英语作业', type:'english', category:'keyStudy', cultivation:15, required:true },
    { id:'t0_4', name:'贤贤老师的作业', type:'math', category:'study', cultivation:10, required:true },
    { id:'t0_5', name:'课外阅读', type:'chinese', category:'study', cultivation:10, required:false },
    { id:'t0_6', name:'户外运动/跳绳', type:'sport', category:'sport', cultivation:8, required:false }
  ]
};
...
function initData() {
  ...
  try {
    if (AppData.config && AppData.config.weeklyTasks) {
      ...
      const hasOldMath = allTasks.some(t => t.name === '数学作业' && !t.name.includes('贤贤'));
      if (hasOldHabit || hasOldEnglish || hasOldMath) {
        console.log('[migration v4] 更新默认任务配置');
...
function renderSubject(subject) {
  ...
  let tasks = getTodayTasks().filter(t => t.type === subject);
  
  // 排除非作业类任务
  const excludeNames = ['课外阅读', '英语绘本/听读', '户外运动/跳绳'];
  tasks = tasks.filter(t => !excludeNames.includes(t.name));
    ...
    try {
      ...
      if (xesTask && xesTask.chapters) {
        ...
        pendingChapters.forEach((chap, idx) => {
          ...
          const isDone = isPending ? 'pendingReview' : 'pending';
          tasks.push({
            id: fakeTaskId,
  ...
  let todayHtml = '';
  if (tasks.length === 0) {
    const isNoHomeworkDay = (day === 3); // 周三无作业日（所有学科）
    if (isNoHomeworkDay) {
      todayHtml = '<div style="text-align:center;color:#999;padding:30px 0;">📢 今天是无作业日，没有' + subjectNames[subject] + '作业</div>';
    } else {
      todayHtml = '<div style="text-align:center;color:#ccc;padding:30px 0;">今天没有' + subjectNames[subject] + '作业</div>';
    }
  } else {
    tasks.forEach(t => {
  ...
  // 专项任务
  const specialTasks = AppData.config.specialTasks.filter(t => t.subject === subject && t.id !== 'sp2' && t.name !== '学而思语文');
  let specialHtml = '';
